...
describe('Invitations', function(){
	...
	describe('#get', function(){
		...
		it('shows a invitation to an admin user', function(done){
			request
				.get('/api/cycles/128f2348-99d4-40a1-b5ab-91d9019f272d/invitations/3350caac-84b9-4827-a5e4-c7a413760a0a')
				.set('Authorization', 'Bearer ' + adminToken)
				.expect(200)
		...
		it('shows a invitation to a non-admin user', function(done){
			request
				.get('/api/cycles/128f2348-99d4-40a1-b5ab-91d9019f272d/invitations/3350caac-84b9-4827-a5e4-c7a413760a0a')
				.set('Authorization', 'Bearer ' + userToken)
				.expect(200)
	...
	describe('#delete', function(){
		...
		it('deletes a invitation for an admin user', function(done){
			request
				.delete('/api/cycles/128f2348-99d4-40a1-b5ab-91d9019f272d/invitations/c7efa7cf-bab2-44a6-862f-7ca5e154b1ae')
				.set('Authorization', 'Bearer ' + adminToken)
				.expect(200)
