...
function Assignment (data, parent) {
	...
	.then(function(self) {
		...
		// check visibility
		return self.parent.cycle.roles.get(self.role_id)
		.then(function(role) {
		...
		// TODO: handle role NotFoundError somehow
...
Assignment.create = function(conn, data, parent) {
	...
	.then(function(admin) {
		...
		return parent.cycle.roles.get(data.role_id)
		.then(function(role) {
...
Assignment.prototype.update = function(conn, delta) {
	...
	.then(function(admin) {
		...
		.then(function() {
			...
			return self.parent.cycle.roles.get(delta.role_id)
