				...
				return r.branch(
					...
					r.branch(
						...
						r.branch(
							...
							// value_equals triggers
							r.branch(
								condition('name').eq('value_equals'),
								project('values')(condition('options')('value_id').default('')).default('').eq(condition('options')('equals').default('')).not().not(),

								// value_regex triggers
								r.branch(
									condition('name').eq('value_regex'),
									project('values')(condition('options')('value_id').default('')).default('').do(function(value){
										return r.branch( value.typeOf().eq('STRING'), value.match(condition('options')('regex').default('')).not().not(), false);
									}),
