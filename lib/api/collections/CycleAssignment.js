...
module.exports = function CycleAssignment(config, resources) {
	return {
		query: function(conn, cycleId, query, user){
			return queryAssignments(conn, cycleId, query, user);
		},

		get: function(conn, cycleId, assignmentId, user){
			return getAssignment(conn, cycleId, assignmentId, user);
		},

		save: function(conn, cycleId, assignmentId, data, user){
			return saveAssignment(conn, cycleId, assignmentId, data, user);
		},

		update: function(conn, cycleId, assignmentId, data, user){
			return updateAssignment(conn, cycleId, assignmentId, data, user);
		},

		delete: function(conn, cycleId, assignmentId, user){
			return deleteAssignment(conn, cycleId, assignmentId, user);
		}
	};
	...
	function updateAssignment(conn, cycleId, assignmentId, data, user){
		...
		return r.table('cycles').get(cycleId).do(function(cycle){
			var delta = {assignments: {}}; delta.assignments[assignmentId] = data;
	...
	function saveAssignment(conn, cycleId, assignmentId, data, user){
		...
		return r.table('cycles').get(cycleId).do(function(cycle){
			var delta = {assignments: {}}; delta.assignments[assignmentId] = r.literal(data);
	...
	function deleteAssignment(conn, cycleId, assignmentId, user){
		...
		return r.table('cycles').get(cycleId).do(function(cycle){
			var delta = {assignments: {}}; delta.assignments[assignmentId] = true;
