...
module.exports = function(config, resources) {
	...
	function Project(role, project, cycle, callback) {
		...
		show: function(req, res, next) {
			...
			resources.db.acquire(function(err, conn) {
				...
				r.expr({
					...
					return Project(role, project, cycle, function(err, project){
			...
			resources.db.acquire(function(err, conn) {
				...
				r.expr({
					...
					if(!req.user.admin){
						...
						// TODO: verify that any new invitations are of allowable roles and users are not already assigned
