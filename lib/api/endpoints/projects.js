...
module.exports = function(config, router, resources){
	...
	// authenticate
	router.use('/api/projects', passport.authenticate('bearer', { session: false }));



	router.use('/api/projects', function(req, res, next){
	...
	router.get('/api/projects/:project', function(req, res){
		return show(req, res);
	});

	router.patch('/api/projects/:project', function(req, res){
		return update(req, res);
	});

	router.delete('/api/projects/:project', function(req, res){
	...
	// authenticate
	router.use('/api/users/:user/projects', passport.authenticate('bearer', { session: false }), function(req, res){
	...
	// authenticate
	router.get('/api/cycles/:cycle/projects', passport.authenticate('bearer', { session: false }), function(req, res){
		return list(req, res);
	});
