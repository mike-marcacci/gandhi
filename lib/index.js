...
module.exports = function(config){
	...
	router.use('/api', function(req, res, next) {
		Object.defineProperty(req, 'admin', {
			get: function(){
				return req.user ? ( req.user.admin && req.query.admin === 'true' ? true : (req.user.admin || false) ) : false;
			}
		});
	...
	require('./api/endpoints/tokens.js')(config, router, resources);
	require('./api/endpoints/users.js')(config, router, resources);
	require('./api/endpoints/cycles.js')(config, router, resources);
	require('./api/endpoints/projects.js')(config, router, resources);
