	...
	resources.components.review = {
		stage: {
			...
			save: function(input, stage, cycle) {
				...
				// make sure permissions are listed
				input.component.permissions['read:public'] = input.component.permissions['read:public'] || {};
				input.component.permissions['read:private'] = input.component.permissions['read:private'] || {};
				input.component.permissions['read:authors'] = input.component.permissions['read:authors'] || {};
