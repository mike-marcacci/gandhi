...
.config(function(GandhiComponentProvider) {
	GandhiComponentProvider.components['form'] = {
		...
		directives: {
			...
			summary: 'gandhi-component-form-summary',
			presentation: 'gandhi-component-form-presentation',
...
.directive('gandhiComponentFormSummary', function() {
	return {
		scope: false,
		templateUrl: 'assets/bower/gandhi-component-form/app/summary.html',
		controller: function($scope, $element, $attrs, $rootScope, Restangular, $state) {
			$scope.$watch('context', function(context) {
				...
				$scope.data = context.project.flow[context.stage].data;
				$scope.status = context.project.flow[context.stage].status;
				$scope.config = { formDefaults: { readonly: true } }; // !$scope.permissions.write
...
.directive('gandhiComponentFormPresentation', function() {
	return {
		scope: false,
		templateUrl: 'assets/bower/gandhi-component-form/app/presentation.html',
		controller: function($scope, $element, $attrs, $rootScope, Restangular, $state) {
			$scope.$watch('context', function(context) {
				...
				$scope.form = $scope.options.presentation || $scope.options.form;
