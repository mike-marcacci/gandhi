...
.config(['schemaFormDecoratorsProvider', function(decoratorsProvider){
  decoratorsProvider.addMapping('bootstrapDecorator', 'ckeditor', 'assets/bower/gandhi-component-form/app/ckeditor.html');
}])

// add the upload decorator
.config(['schemaFormDecoratorsProvider', function(decoratorsProvider){
  decoratorsProvider.addMapping('bootstrapDecorator', 'upload', 'assets/bower/gandhi-component-form/app/upload.html');
}])
