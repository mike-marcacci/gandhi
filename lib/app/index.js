...
.factory('auth', ['$rootScope', 'Restangular', '$window', '$q', function($rootScope, Restangular, $window, $q){
	'use strict';
	...
	function signup(data){
		...
		return Restangular.all('users').post(data).then(function(){ login(data); }, $q.reject);
	}
...
.config(['$httpProvider', '$stateProvider', 'RestangularProvider', function($httpProvider, $stateProvider, RestangularProvider){
	'use strict';
