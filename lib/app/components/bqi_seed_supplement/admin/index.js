...
.controller('Components.Admin.BqiSeedSupplement', function($scope, $state, Restangular, $upload) {

	$scope.data = $scope.stage.project.data ? angular.copy($scope.stage.project.data) : {
		biosketches: [],
		team_publications: [{}, {}, {}, {}, {}],
		area_publications: [{}, {}, {}, {}, {}],
		budget: [{}],
	...
	$scope.submit = function() {
		...
		// add the stage data
		val.flow.stages[$scope.stage.cycle.id] = {
			status: 'submitted',
			data: $scope.data
		}
