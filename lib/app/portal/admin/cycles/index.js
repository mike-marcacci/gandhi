...
.config(function($stateProvider) {
	...
	.state('portal.admin.cycles.create', {
		...
		controller: ['$scope', '$state', '$window', 'Cycle', function($scope, $state, $window, Cycle){
	...
	.state('portal.admin.cycles.show', {
		...
		controller: ['$scope', '$rootScope', '$state', '$stateParams', '$window', 'Cycle', 'Role', 'Status', function($scope, $rootScope, $state, $stateParams, $window, Cycle, Role, Status){
			$scope.refresh = function(){
				$rootScope.$broadcast('cycles', $stateParams.cycle);
			};
	...
	.state('portal.admin.cycles.show.assignments', {
		...
		controller: ['$scope', '$state', '$stateParams', '$window', 'Assignment', 'User', function($scope, $state, $stateParams, $window, Assignment, User) {
			$scope.assignments = [];

			$scope.assignmentCreate = null;
			$scope.toggleCreate = function(assignment) {
			...
			function getAssignments(){
				$scope.assignments = Assignment.query({cycle: $stateParams.cycle});
				$scope.backup = {};
			}
