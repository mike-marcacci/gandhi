...
.config(function($stateProvider, RestangularProvider) {
	...
	$stateProvider
		...
		.state('portal.admin.cycles.show.flow.stage', {
			url: '/:stage',
			template: '<div gandhi-component="{cycle: cycle, project: project, stage: stage || cycle.defaults.flow, role: role, mode: \'admin\'}"></div>',
			controller: function ($scope, $state, $stateParams, Restangular) {
				$scope.$parent.stage = $stateParams.stage || $scope.cycle.stage;
