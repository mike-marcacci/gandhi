		...
		controller: ['$scope', 'Cycle', function($scope, Cycle){
			$scope.table = {
				...
				columns: [
					...
					{primary: true, sortable: true, title: 'Status', path: ['status_id'], template: '<span style="text-transform: capitalize;">{{row.status_id}}</span>'},
					{primary: false, sortable: true, title: 'Created', path: ['created'], template: '{{row.created * 1000 | date:"yyyy.MM.dd - hh:mm a"}}'},
					{primary: false, sortable: true, title: 'Updated', path: ['updated'], template: '{{row.updated * 1000 | date:"yyyy.MM.dd - hh:mm a"}}'}
				]
			};
