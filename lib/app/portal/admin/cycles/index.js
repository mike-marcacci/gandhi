...
.config(function($stateProvider) {
	...
	.state('portal.admin.cycles.show', {
		...
		controller: ['$scope', '$rootScope', '$state', '$stateParams', '$window', 'Cycle', 'Role', function($scope, $rootScope, $state, $stateParams, $window, Cycle, Role){
			$scope.edit = false;
